...
const form = ref({
  ...
  location: 'Industriestrasse 42',
  zip: '8400',
  city: 'Winterthur',
  salutation_admin: 'Frau',
  firstname_admin: 'Anna',
  name_admin: 'Schmidt',
  email_admin: 'marcel.stadelmann@gmail.com',
  phone_admin: '+41 52 987 65 43',
  salutation_authorised_to_sign: 'Herr',
  firstname_authorised_to_sign: 'Peter',
  name_authorised_to_sign: 'Meier',
  email_authorised_to_sign: 'marcel.stadelmann@gmail.com',
  phone_authorised_to_sign: '+41 52 111 22 33',
  location_authorised_to_sign: 'Hauptstrasse 15',
  zip_authorised_to_sign: '8400',
  city_authorised_to_sign: 'Winterthur',
  dob_authorised_to_sign: '22.07.1975',
  commercial_register: [],
  id_copy: [],
  power_of_attorney: []
});
